...
<p style="line-height: 1.6; margin: 0 0 10px; padding: 0;">
    Вы зарегистрировались в сервисе <a href="<?= \Yii::$app->params['maindUrl'] . Url::toRoute(["/site/index"], false); ?>" style="color: #84bf76; margin: 0; padding: 0;">F-keeper</a>
</p>
...
<div style="text-align: center; width: 100%; margin: 0; padding: 0;" align="center">
    <a href="<?= \Yii::$app->params['maindUrl'] . Url::to(["/user/confirm", "type" => $user->organization->type_id, "token" => $userToken->token], false); ?>" 
