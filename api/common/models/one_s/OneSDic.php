 ...
 */
class OneSDic extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(OneSDictype::className(), ['id' => 'dictype_id']);
    }
    ...
    {
        return $this->hasOne(OneSDicstatus::className(), ['id' => 'dicstatus_id']);
    }
    ...
    public function updateSuccessSync($count)
    {
        ...
        $this->dicstatus_id = OneSDic::STATUS_SUCCESS;
        if ($this->save()) {
            return true;
        } else {
            return false;
    ...
    public static function errorSync($id)
    {
        ...
        $model->dicstatus_id = OneSDic::STATUS_ERROR;
        $model->save();
    }
}
