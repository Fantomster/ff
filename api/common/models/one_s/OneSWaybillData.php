...
class OneSWaybillData extends \yii\db\ActiveRecord
{
    ...
    {
        return OneSWaybill::findOne(['id' => $this->waybill_id]);
    }
     ...
     */
    public function getOneSProduct()
    {
        return $this->hasOne(OneSGood::className(), ['id' => 'product_rid']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getMixCartProduct()
    {
