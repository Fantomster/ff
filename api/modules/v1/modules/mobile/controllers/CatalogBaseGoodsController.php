...
class CatalogBaseGoodsController extends ActiveController {
    ...
    public function prepareDataProvider()
    {
        ...
        */
        ...
        $query1 = "
            SELECT  cbg.id as product_id, cbg.product, cbg.units, cbg.price, cbg.cat_id, cbg.weight, org.name as organization_name, cbg.ed, curr.symbol, cbg.note 
        ...
        $query2 = "SELECT cbg.id as product_id, cbg.product, cbg.units, cg.price, cg.cat_id, cbg.weight, org.name as organization_name, cbg.ed, curr.symbol, cbg.note
            FROM catalog_base_goods AS cbg 
