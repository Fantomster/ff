    ...
    public function prepareDataProvider()
    {
        ...
        SELECT * FROM (
            ...
            WHERE ($where)
                ...
                AND (cbg.deleted = 0) 
            UNION ALL
            (SELECT gp.id, cbg.id as cbg_id, cbg.product, cbg.units, cg.price, cg.cat_id, org.name as name, cbg.ed, curr.symbol, cbg.note, org.id as supp_org_id, org.name as organization_name, cbg.created_at as created_at
            FROM guide_product AS gp
                    LEFT JOIN catalog_base_goods AS cbg ON gp.cbg_id = cbg.id
