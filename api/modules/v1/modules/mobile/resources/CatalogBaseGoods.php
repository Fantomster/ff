...
class CatalogBaseGoods extends \common\models\CatalogBaseGoods
{
    ...
    {
        return ['id', 'cat_id', 'article', 'product', 'status', 'market_place', 'deleted', 'created_at', 'supp_org_id', 
                'updated_at', 'category_id', 'note', 'ed', 'image', 'brand', 'region', 'weight', 'es_status', 'mp_show_price', 'rating'];
    }
