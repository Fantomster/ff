...
if (!empty($lastMessage)) {
    $messageTitle = $self ? Yii::t('app', 'common.mail.order_changed.self_title', ['ru' => 'Вы изменили детали заказа №']) : Yii::t('app', 'common.mail.order_changed.another_party_title', ['ru' => '{org_name} изменил детали заказа №', 'org_name' => $senderOrg->name]);
                ...
                <tr>
                    <td align="center" valign="top" style="padding: 0 20px 16px 20px;">
                        <table cellpadding="0" cellspacing="0" width="100%" style="border-radius: 4px;">
                            ...
                            <tr>
                                <td colspan="2" style="font-family: 'Open Sans', Arial, sans-serif;font-size: 16px;color: #8c8f8d;">
                                    <span style="font-family: 'Open Sans', Arial, sans-serif;font-size: 16px;color: #8c8f8d;"><?= $messageTitle ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="font-family: 'Open Sans', Arial, sans-serif;font-size: 16px;color: #8c8f8d;padding: 0 0 0 20px;">
                                    <?= $messageList ?>
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle" style="padding: 20px 0;font-family: 'Open Sans', Arial, sans-serif;font-size: 16px;color: #8c8f8d;">
                            ...
                            <tr>
                                <?php if ($recipientIsClient) { ?>
                                    <td valign="middle" style="font-family: 'Open Sans', Arial, sans-serif;color: #8c8f8d;font-size: 16px;">
