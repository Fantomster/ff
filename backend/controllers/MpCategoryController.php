...
use backend\models\MpCategorySearch;
...
class MpCategoryController extends Controller
{
    ...
    /**
     * Displays a single MpCategory model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MpCategory model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
//    public function actionCreate()
//    {
//        $model = new MpCategory();
//
...
//    }
    ...
    /**
     * Updates an existing MpCategory model.
    ...
    /**
     * Deletes an existing MpCategory model.
...
//    }
    ...
    /**
     * Finds the MpCategory model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return MpCategory the loaded model
