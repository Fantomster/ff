...
use api\common\models\one_s\search\OneSServiceSearch;
...
class OdinsobshController extends Controller
{
    ...
    {
        $searchModel = new OneSServiceSearch();
    ...
    {
        if (($model = OneSService::findOne($id)) !== null) {
            return $model;
        } else {
