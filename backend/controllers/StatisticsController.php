...
class StatisticsController extends Controller {
    ...
    private $blacklist = '(0)';//'(1,2,5,16,63,88,99,100,106,108,111,114,116,272,284,333,440,449,526,673,784,824,1037)'; //1,2,5,16,63,88,99,106,108,111,114,116,272,284,333,440,449,526,673,784,824,1037
    ...
    public function actionMisc() {
        ...
        $productsOnMarketCount = CatalogBaseGoods::find()
                ->where(['deleted' => CatalogBaseGoods::DELETED_OFF, 'market_place' => CatalogBaseGoods::MARKETPLACE_ON])
                ->andWhere(['between', "$cbgTable.created_at", $dt->format('Y-m-d'), $end->format('Y-m-d')])
                ->count();
