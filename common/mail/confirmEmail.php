...
<p style="line-height: 1.6; margin: 0 0 10px; padding: 0;">
    <?= Yii::t('app', 'common.mail.confirm_email.you_registered', ['ru'=>'Вы зарегистрировались в сервисе']) ?> <a href="<?= Yii::$app->urlManagerFrontend->createUrl(["/site/index"], true); ?>" style="color: #84bf76; margin: 0; padding: 0;">MixCart</a>
</p>
