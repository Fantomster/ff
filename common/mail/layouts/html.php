                    ...
                    <td style="margin: 0; padding: 0;">
                        <div style="margin: 0; padding: 0;">
                            <ul style="width: 100%; text-align: center; font-weight: normal; font-size: 14px; line-height: 1.6; list-style-type: none; margin: 0 0 10px; padding: 0;">
                                ...
                                <li style="display: inline-block; text-align: center; list-style-position: inside; margin: 0 0 0 5px; padding: 0;"><img src="https://mixcart.ru/img/web.png" alt="" style="max-width: 100%; margin: 0; padding: 0 5px 0 0;" /><a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(["/site/index"]) ?>" style="color: #3f3e3e; margin: 0; padding: 0;">mixcart.ru</a></li>
                            </ul>
                        </div>
