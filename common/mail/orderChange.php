...
<p style="font-weight: normal; font-size: 14px; line-height: 1.6; margin: 0 0 10px; padding: 0;">
    <?= $orgType . ' ' . $senderOrg->name . Yii::t('app', 'common.mail.order_change.change', ['ru'=>' внес изменения в заказ №']) . $order->id ?>
</p>
<p style="font-weight: normal; font-size: 14px; line-height: 1.6; margin: 0 0 10px; padding: 0;">
    <?= Yii::t('app', 'common.mail.order_change.link_for_details', ['ru'=>'Для просмотра деталей пройдите по ссылке:']) ?>
</p>
