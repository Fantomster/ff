                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" style="border-radius: 4px;">
                            ...
                            <tr>
                                <td valign="middle" style="padding: 20px 0;font-family: 'Open Sans', Arial, sans-serif;font-size: 16px;color: #8c8f8d;">
                                    <span  style="font-family: 'Open Sans', Arial, sans-serif;font-size: 16px;color: #8c8f8d;margin: 0;"><?= Yii::t('app', 'common.mail.order_changed.string1', ['ru' => 'Измененный заказ вы можете просмотреть ниже.']) ?></span>
                                </td>
                            </tr>
                            <tr>
