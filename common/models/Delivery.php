 ...
 * @property string $min_free_delivery_charge           Минимальная стоимость заказа, при которой доставка
 *           осуществляется бесплатно
 * @property int    $mon                                Показатель возможности доставки заказа в понедельник (0 - нет
 *           доставки, 1
 *           - доставка возможна)
 * @property int    $tue                                Показатель возможности доставки заказа во вторник (0 - нет
 *           доставки, 1 - доставка возможна)
 * @property int    $wed                                Показатель возможности доставки заказа в среду (0 - нет
 *           доставки, 1 - доставка возможна)
 * @property int    $thu                                Показатель возможности доставки заказа в четверг (0 - нет
 *           доставки, 1 - доставка возможна)
 * @property int    $fri                                Показатель возможности доставки заказа в пятницу (0 - нет
 *           доставки, 1 - доставка возможна)
 * @property int    $sat                                Показатель возможности доставки заказа в субботу (0 - нет
 *           доставки, 1 - доставка возможна)
 * @property int    $sun                                Показатель возможности доставки заказа в воскресенье (0 - нет
 *           доставки, 1
 *           - доставка возможна)
 * @property string $min_order_price                    Минимальная стоимость заказа
 * @property string $delivery_discount_percent          Минимальная стоимость заказа
...
class Delivery extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['delivery_charge', 'min_free_delivery_charge', 'min_order_price', 'delivery_discount_percent'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'delivery_discount_percent' => 'Скидка на доставку в процентах',
        ];
    }
