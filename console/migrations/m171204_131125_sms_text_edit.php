...
/**
 * Class m171204_131125_sms_text_edit
 */
class m171204_131125_sms_text_edit extends Migration
{
    private $file = '/files/sms_text_edit.csv';
    //Категория сообщений
    private $category = 'sms_message';
    //Сообщения для удаления
    private $delete_messages = ['sms.client_want_to_work', 'sms.changed_order_detail'];
