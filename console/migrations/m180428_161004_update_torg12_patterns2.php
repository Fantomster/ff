...
/**
 * Class m180428_161004_update_torg12_patterns2
 */
class m180428_161004_update_torg12_patterns2 extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->execute( "INSERT INTO integration_torg12_columns (id,name,value,regular_expression) VALUES 
              ...
              ,(8,'price_without_tax','Цена|цена|цена без ндс|цена без ндс, руб.|цена без ндс руб.|цена без учета ндс|цена без учета ндс, руб.|цена без учета ндс руб.|цена, руб. коп.|цена руб. коп.|цена руб. коп|цена (тариф) за единицу измерения',0)
    ...
    {
        echo "m180428_161004_update_torg12_patterns2 cannot be reverted. But it is OK\n";
    ...
    {
        echo "m180428_161004_update_torg12_patterns2 cannot be reverted.\n";
