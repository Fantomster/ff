...
class m180928_071046_create_license_organization_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('license_organization', [
            ...
            'fd' => $this->timestamp()->null()->comment('Начало действия услуги'),
            'td' => $this->timestamp()->null()->comment('Окончание действия услуги'),
            ...
            'outer_last_active' => $this->timestamp()->null()->comment('Время последней зарегистрированной активности'),
