...
<section class="content-header">
    <h1>
        <i class="fa fa-home"></i> <?= Yii::t('app', 'Поставщик') ?> <?= $organization->name ?>
    </h1>
</section>
    ...
    <div class="box box-info order-history">
        <div class="box-body">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><?= Yii::t('app', 'Поставщик') ?></a></li>
                <?php if($showButton): ?>
                <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false"><?= Yii::t('app', 'Реквизиты') ?></a></li>
                <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false"><?= Yii::t('app', 'Список ресторанов поставщика') ?></a></li>
                <?php endif; ?>
                <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false"><?= Yii::t('app', 'Список сотрудников поставщика') ?></a></li>
            </ul>
            <div class="modal-content tab-content" style="box-shadow: 0 2px 3px rgba(0,0,0,0.125);">
                <div class="modal-body tab-pane active" id="tab_1">
                    ...
                    <div class="row">
                        <div class="col-md-4" style="text-align: center;">
                            ...
                            <?php if ($showButton): ?>
                                <div class="btn-edite">
                                    <?= isset($catalog->id) ? Html::a(Yii::t('app', 'Прайс-листы поставщика'), ['catalog/index', 'vendor_id' => $organization->id], ['class' => 'btn btn-green btn-block']) : '' ?>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="col-md-8">
                ...
                <div class="modal-body tab-pane" id="tab_2">
                    <div class="modal-header f-header">
                        <h4 class="modal-title f-title"><?= Yii::t('app', 'Реквизиты поставщика') ?> <?= $organization->name ?></h4>
                    </div>
                ...
                <div class="modal-body tab-pane" id="tab_3">
                    <div class="modal-header f-header">
                        <h4 class="modal-title f-title"><?= Yii::t('app', 'Список ресторанов поставщика') ?> <?= $organization->name ?></h4>
                    </div>
                    <?php
...
//                                            if ($progress > 0) {
                                        ...
                                        'label' => Yii::t('app', 'Кол-во поставщиков'),
                                    ],
                                    [
                                        'format' => 'raw',
...
//                                    ],
                ...
                <div class="modal-body tab-pane" id="tab_4">
                    <div class="modal-header f-header">
                        <h4 class="modal-title f-title"><?= Yii::t('app', 'Список сотрудников поставщика') ?> <?= $organization->name ?></h4>
                    </div>
                    <div class="row">
                        <?= GridView::widget([
