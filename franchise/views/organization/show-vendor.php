    ...
    <div class="box box-info order-history">
        <div class="box-body">
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">Список ресторанов поставщика</a>
                </li>
                <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false">Список сотрудников поставщика</a>
            </ul>
