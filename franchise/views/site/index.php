...
<section class="content-header">
    <h1>
        <i class="fa fa-home"></i> <?= Yii::t('app', 'Главная') ?>
        <small><?= Yii::t('app', 'Рабочий стол') ?></small>
    </h1>
</section>
<section class="content">
    <div class="row hidden-xs">
        <div class="col-md-8">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= Yii::t('app', 'Объем продаж ваших клиентов за последние 30 дней') ?></h3>
                    <div class="box-tools pull-right">
                        <?= Html::a(Yii::t('app', "Аналитика"), ["analytics/index"], ["class" => "btn btn-success btn-sm"]) ?>
                    </div>
                </div>
                <div class="box-body">
                    <div class="chart">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="description-block border-right">
                                ...
                                <span class="description-text"><?= Yii::t('app', 'Ваша прибыль') ?></span>
                            </div>
                            <!-- /.description-block -->
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-3 col-xs-6">
                            <div class="description-block border-right">
                                ...
                                <span class="description-text"><?= Yii::t('app', 'Роялти MixCart') ?></span>
                            </div>
                            <!-- /.description-block -->
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="description-block border-right">
                                ...
                                <span class="description-text"><?= Yii::t('app', 'Общее кол-во заказов') ?></span>
                            </div>
                            <!-- /.description-block -->
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-3 col-xs-6">
                            <div class="description-block">
                                ...
                                <span class="description-text"><?= Yii::t('app', 'Клиентов') ?></span>
                            </div>
                            <!-- /.description-block -->
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= Yii::t('app', 'Статистика') ?></h3>
                    <div class="box-tools pull-right">
                        <a class="btn btn-success btn-sm" href="<?= Url::to(['client/suppliers']) ?>"><?= Yii::t('app', 'Финансовая аналитика') ?></a>          </div>
                </div>
                ...
                <div class="box-body">
                    <div class="home-pay-chek">
                        <table class="pay-table" width="100%">
                            <tbody><tr>
                                    <th><?= Yii::t('app', 'Общая финансовая аналитика') ?></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th><?= Yii::t('app', 'Зарегистрировано') ?></th>
                                </tr>
                                <tr>
                                    <td style="text-align: left;"><?= Yii::t('app', 'Поставщиков:') ?></td>
                                    <td style="text-align: right; font-size: 18px; font-weight: bold;"> <?= $vendorsCount ?></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;"><?= Yii::t('app', 'Ресторанов:') ?></td>
                                    <td style="text-align: right; font-size: 18px; font-weight: bold;"> <?= $clientsCount ?></td>
                                </tr>
                                <tr><td></td></tr>
                                <tr>
                                    <th><?= Yii::t('app', 'Заказы и оборот') ?></th>
                                </tr>
                                <tr>
                                    <td style="text-align: left;"><?= Yii::t('app', 'Заказов:') ?></td>
                                    <td style="text-align: right; font-size: 18px; font-weight: bold;"> <?= $dataProvider->getTotalCount() ?></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;"><?= Yii::t('app', 'Оборот:') ?></td>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= Yii::t('app', 'История заказов') ?></h3>
                    <div class="box-tools pull-right">
                        <?= Html::a(Yii::t('app', "История заказов"), ['site/orders'], ["class" => "btn btn-success btn-sm"]) ?>
                    </div>
                </div>
