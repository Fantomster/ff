...
/**
 * Class GenericEntity
 * @package frontend\modules\clientintegr\modules\merc\helpers\api\dicts
 * v 2.0
 */
...
class Dicts
{
    ...
    function GetPurposeByGuid(getPurposeByGuidRequest $getPurposeByGuidRequest)
    {

        $getPurposeByGuidResponse = $this->soapClient->GetPurposeByGuid($getPurposeByGuidRequest);
        return $getPurposeByGuidResponse;

    }
    function GetPurposeByUuid(getPurposeByUuidRequest $getPurposeByUuidRequest)
    {

        $getPurposeByUuidResponse = $this->soapClient->GetPurposeByUuid($getPurposeByUuidRequest);
        return $getPurposeByUuidResponse;

    }
    function GetPurposeList(getPurposeListRequest $getPurposeListRequest)
    {

        $getPurposeListResponse = $this->soapClient->GetPurposeList($getPurposeListRequest);
        return $getPurposeListResponse;

    }
    function GetPurposeChangesList(getPurposeChangesListRequest $getPurposeChangesListRequest)
    {

        $getPurposeChangesListResponse = $this->soapClient->GetPurposeChangesList($getPurposeChangesListRequest);
        return $getPurposeChangesListResponse;

    }
    function GetUnitByGuid(getUnitByGuidRequest $getUnitByGuidRequest)
    {

        $getUnitByGuidResponse = $this->soapClient->GetUnitByGuid($getUnitByGuidRequest);
        return $getUnitByGuidResponse;

    }
    function GetUnitByUuid(getUnitByUuidRequest $getUnitByUuidRequest)
    {

        $getUnitByUuidResponse = $this->soapClient->GetUnitByUuid($getUnitByUuidRequest);
        return $getUnitByUuidResponse;

    }
    function GetUnitList(getUnitListRequest $getUnitListRequest)
    {

        $getUnitListResponse = $this->soapClient->GetUnitList($getUnitListRequest);
        return $getUnitListResponse;

    }
    function GetUnitChangesList(getUnitChangesListRequest $getUnitChangesListRequest)
    {

        $getUnitChangesListResponse = $this->soapClient->GetUnitChangesList($getUnitChangesListRequest);
        return $getUnitChangesListResponse;

    }
    function GetDiseaseByGuid(getDiseaseByGuidRequest $getDiseaseByGuidRequest)
    {

        $getDiseaseByGuidResponse = $this->soapClient->GetDiseaseByGuid($getDiseaseByGuidRequest);
        return $getDiseaseByGuidResponse;

    }
    function GetDiseaseByUuid(getDiseaseByUuidRequest $getDiseaseByUuidRequest)
    {

        $getDiseaseByUuidResponse = $this->soapClient->GetDiseaseByUuid($getDiseaseByUuidRequest);
        return $getDiseaseByUuidResponse;

    }
    function GetDiseaseList(getDiseaseListRequest $getDiseaseListRequest)
    {

        $getDiseaseListResponse = $this->soapClient->GetDiseaseList($getDiseaseListRequest);
        return $getDiseaseListResponse;

    }
    function GetDiseaseChangesList(getDiseaseChangesListRequest $getDiseaseChangesListRequest)
    {

        $getDiseaseChangesListResponse = $this->soapClient->GetDiseaseChangesList($getDiseaseChangesListRequest);
        return $getDiseaseChangesListResponse;

    }
    function GetResearchMethodByGuid(getResearchMethodByGuidRequest $getResearchMethodByGuidRequest)
    {

        $getResearchMethodByGuidResponse = $this->soapClient->GetResearchMethodByGuid($getResearchMethodByGuidRequest);
        return $getResearchMethodByGuidResponse;

    }
    function GetResearchMethodByUuid(getResearchMethodByUuidRequest $getResearchMethodByUuidRequest)
    {

        $getResearchMethodByUuidResponse = $this->soapClient->GetResearchMethodByUuid($getResearchMethodByUuidRequest);
        return $getResearchMethodByUuidResponse;

    }
    function GetResearchMethodList(getResearchMethodListRequest $getResearchMethodListRequest)
    {

        $getResearchMethodListResponse = $this->soapClient->GetResearchMethodList($getResearchMethodListRequest);
        return $getResearchMethodListResponse;

    }
    function GetResearchMethodChangesList(getResearchMethodChangesListRequest $getResearchMethodChangesListRequest)
    {

        $getResearchMethodChangesListResponse = $this->soapClient->GetResearchMethodChangesList($getResearchMethodChangesListRequest);
