...
/**
 * Class GenericEntity
 * @package frontend\modules\clientintegr\modules\merc\helpers\api\ikar
 * v 2.0
 */
class GenericEntity{
    var $uuid;//UUID
...
class Ikar
{
    ...
    function GetAllCountryList(getAllCountryListRequest $getAllCountryListRequest)
    {

        $getAllCountryListResponse = $this->soapClient->GetAllCountryList($getAllCountryListRequest);
        return $getAllCountryListResponse;

    }
    function GetCountryByGuid(getCountryByGuidRequest $getCountryByGuidRequest)
    {

        $getCountryByGuidResponse = $this->soapClient->GetCountryByGuid($getCountryByGuidRequest);
        return $getCountryByGuidResponse;

    }
    function GetCountryByUuid(getCountryByUuidRequest $getCountryByUuidRequest)
    {

        $getCountryByUuidResponse = $this->soapClient->GetCountryByUuid($getCountryByUuidRequest);
        return $getCountryByUuidResponse;

    }
    function GetCountryChangesList(getCountryChangesListRequest $getCountryChangesListRequest)
    {

        $getCountryChangesListResponse = $this->soapClient->GetCountryChangesList($getCountryChangesListRequest);
        return $getCountryChangesListResponse;

    }
    function GetRegionListByCountry(getRegionListByCountryRequest $getRegionListByCountryRequest)
    {

        $getRegionListByCountryResponse = $this->soapClient->GetRegionListByCountry($getRegionListByCountryRequest);
        return $getRegionListByCountryResponse;

    }
    function GetRegionByGuid(getRegionByGuidRequest $getRegionByGuidRequest)
    {

        $getRegionByGuidResponse = $this->soapClient->GetRegionByGuid($getRegionByGuidRequest);
        return $getRegionByGuidResponse;

    }
    function GetRegionByUuid(getRegionByUuidRequest $getRegionByUuidRequest)
    {

        $getRegionByUuidResponse = $this->soapClient->GetRegionByUuid($getRegionByUuidRequest);
        return $getRegionByUuidResponse;

    }
    function GetRegionChangesList(getRegionChangesListRequest $getRegionChangesListRequest)
    {

        $getRegionChangesListResponse = $this->soapClient->GetRegionChangesList($getRegionChangesListRequest);
        return $getRegionChangesListResponse;

    }
    function GetDistrictListByRegion(getDistrictListByRegionRequest $getDistrictListByRegionRequest)
    {

        $getDistrictListByRegionResponse = $this->soapClient->GetDistrictListByRegion($getDistrictListByRegionRequest);
        return $getDistrictListByRegionResponse;

    }
    function GetDistrictByGuid(getDistrictByGuidRequest $getDistrictByGuidRequest)
    {

        $getDistrictByGuidResponse = $this->soapClient->GetDistrictByGuid($getDistrictByGuidRequest);
        return $getDistrictByGuidResponse;

    }
    function GetDistrictByUuid(getDistrictByUuidRequest $getDistrictByUuidRequest)
    {

        $getDistrictByUuidResponse = $this->soapClient->GetDistrictByUuid($getDistrictByUuidRequest);
        return $getDistrictByUuidResponse;

    }
    function GetDistrictChangesList(getDistrictChangesListRequest $getDistrictChangesListRequest)
    {

        $getDistrictChangesListResponse = $this->soapClient->GetDistrictChangesList($getDistrictChangesListRequest);
        return $getDistrictChangesListResponse;

    }
    function GetLocalityListByRegion(getLocalityListByRegionRequest $getLocalityListByRegionRequest)
    {

        $getLocalityListByRegionResponse = $this->soapClient->GetLocalityListByRegion($getLocalityListByRegionRequest);
        return $getLocalityListByRegionResponse;

    }
    function GetLocalityListByDistrict(getLocalityListByDistrictRequest $getLocalityListByDistrictRequest)
    {

        $getLocalityListByDistrictResponse = $this->soapClient->GetLocalityListByDistrict($getLocalityListByDistrictRequest);
        return $getLocalityListByDistrictResponse;

    }
    function GetLocalityListByLocality(getLocalityListByLocalityRequest $getLocalityListByLocalityRequest)
    {

        $getLocalityListByLocalityResponse = $this->soapClient->GetLocalityListByLocality($getLocalityListByLocalityRequest);
        return $getLocalityListByLocalityResponse;

    }
    function GetStreetListByLocality(getStreetListByLocalityRequest $getStreetListByLocalityRequest)
    {

        $getStreetListByLocalityResponse = $this->soapClient->GetStreetListByLocality($getStreetListByLocalityRequest);
        return $getStreetListByLocalityResponse;

    }
    function FindLocalityListByName(findLocalityListByNameRequest $findLocalityListByNameRequest)
    {

        $findLocalityListByNameResponse = $this->soapClient->FindLocalityListByName($findLocalityListByNameRequest);
        return $findLocalityListByNameResponse;

    }
    function FindStreetListByName(findStreetListByNameRequest $findStreetListByNameRequest)
    {

        $findStreetListByNameResponse = $this->soapClient->FindStreetListByName($findStreetListByNameRequest);
        return $findStreetListByNameResponse;
