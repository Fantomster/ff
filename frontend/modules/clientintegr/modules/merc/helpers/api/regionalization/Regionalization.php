...
class Enterprise{
    ...
    var $registryStatus;//EnterpriseStatus
}
...
class getLocalityChangesListRequest{
    var $listOptions;//ListOptions
    var $updateDateInterval;//DateInterval
}
class getLocalityChangesListResponse{
    var $localityList;//LocalityList
}
class getStreetChangesListRequest{
    var $listOptions;//ListOptions
    var $updateDateInterval;//DateInterval
}
class getStreetChangesListResponse{
    var $streetList;//StreetList
}
...
class Regionalization
{
    ...
    ,'getLocalityChangesListRequest'=>'getLocalityChangesListRequest'
    ,'getLocalityChangesListResponse'=>'getLocalityChangesListResponse'
    ,'getStreetChangesListRequest'=>'getStreetChangesListRequest'
    ,'getStreetChangesListResponse'=>'getStreetChangesListResponse'
    ...
    function GetR13nConditionList(getR13nConditionListRequest $getR13nConditionListRequest)
    {

        $getR13nConditionListResponse = $this->soapClient->GetR13nConditionList($getR13nConditionListRequest);
        return $getR13nConditionListResponse;

    }
    function GetActualR13nRegionStatusList(getActualR13nRegionStatusListRequest $getActualR13nRegionStatusListRequest)
    {

        $getActualR13nRegionStatusListResponse = $this->soapClient->GetActualR13nRegionStatusList($getActualR13nRegionStatusListRequest);
        return $getActualR13nRegionStatusListResponse;

    }
    function GetActualR13nShippingRuleList(getActualR13nShippingRuleListRequest $getActualR13nShippingRuleListRequest)
    {

        $getActualR13nShippingRuleListResponse = $this->soapClient->GetActualR13nShippingRuleList($getActualR13nShippingRuleListRequest);
        return $getActualR13nShippingRuleListResponse;
