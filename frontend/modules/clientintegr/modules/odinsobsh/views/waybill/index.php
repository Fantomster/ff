...
/**
 * OneS integration service - order list view [basic]
 *
...
$this->title = Yii::t('message', 'frontend.clientintegr.ones.waybill', ['ru' => 'Интеграция с 1С Общепит']);
...
//            $nacl = OneSWaybill::findOne(['order_id' => $data->id]);
...
//    ],
    ...
    [
        ...
        'detail'        => function ($model) use ($lic) {
            ...
            if ($wmodel) {
                $wmodel = OneSWaybill::find()->andWhere('order_id = :order_id', [':order_id' => $model->id]);
            } else {
                $wmodel = null;
            }
            $order_id = $model->id;
...
<section class="content-header">
    <h1>
        <i class="fa fa-history"></i> <?= Yii::t('message', 'frontend.clientintegr.ones.waybill', ['ru' => 'Интеграция с 1С Общепит']) ?>
    </h1>
    <?=
    Breadcrumbs::widget([
                    ...
                    <div class="box-body table-responsive2 no-padding orders-table">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6">
                                ...
                                <a class="btn btn-warning" href="<?= Url::to(['/clientintegr/odinsobsh/waybill']) ?>">Сбросить
                                    фильтры</a>
                            </div>
