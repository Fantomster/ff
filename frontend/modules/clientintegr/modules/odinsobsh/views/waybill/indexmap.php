                                    ...
                                    [
                                        ...
                                        'buttons'        => [
                                            ...
                                            'ten'      => function ($url, $model) {
                                                ...
                                                $customurl = Yii::$app->getUrlManager()->createUrl(['clientintegr/odinsobsh/waybill/chvat', 'id' => $model->id, 'koef' => $model->koef, 'vatf' => $vatf, 'vat' => '1000', 'page' => $page, 'sort' => $sort, 'way' => $way]);
                                            ...
                                            'eighteen' => function ($url, $model) {
                                                ...
                                                $customurl = Yii::$app->getUrlManager()->createUrl(['clientintegr/odinsobsh/waybill/chvat', 'id' => $model->id, 'koef' => $model->koef, 'vatf' => $vatf, 'vat' => '1800', 'page' => $page, 'sort' => $sort, 'way' => $way]);
...
$(function () {
    function links_column3 () {
            ...
            $('.button-name').on('click', function () {
                ...
                swal({
                    html: '<i class="glyphicon glyphicon-edit"></i>  <span style="font-size:14px">Редактировать продукт 1С Общепит</span></br></br><span id="tovar">товар</span></br></br>' +
