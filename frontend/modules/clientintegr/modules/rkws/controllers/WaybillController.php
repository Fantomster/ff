...
class WaybillController extends \frontend\modules\clientintegr\controllers\DefaultController
{
    ...
    public function actionIndex()
    {
        ...
        $search->getRestaurantIntegration(SearchOrdersComponent::INTEGRATION_TYPE_RKWS, $searchModel, $organization->id, $this->currentUser->organization_id, $wbStatuses, ['pageSize' => 20], ['defaultOrder' => ['id' => SORT_DESC]]);
