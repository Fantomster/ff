        ...
        [
            ...
            'buttons' => [
                ...
                'update' => function ($url, $model) {
                    ...
                    $customurl = Yii::$app->getUrlManager()->createUrl(['clientintegr/rkws/waybill/update', 'id' => $model->id, 'page' => $page]);
                ...
                'map'    => function ($url, $model) {
                    ...
                    $customurl = Yii::$app->getUrlManager()->createUrl(['clientintegr/rkws/waybill/map', 'waybill_id' => $model->id, 'way' => 0, 'RkWaybilldataSearch[vat]' => 1, 'page' => $page]);
