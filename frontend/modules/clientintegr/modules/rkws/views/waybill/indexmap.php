...
$sLinktwenty = Url::base(true) . Yii::$app->getUrlManager()->createUrl(['clientintegr/rkws/waybill/makevat', 'waybill_id' => $wmodel->id, 'vat' => 2000]);
                            ...
                            [
                                ...
                                'buttons'        => [
                                    ...
                                    'twenty'   => function ($url, $model) {
                                        ...
                                        $customurl = Yii::$app->getUrlManager()->createUrl(['clientintegr/rkws/waybill/chvat', 'id' => $model->id, 'koef' => $model->koef, 'vatf' => $vatf, 'vat' => '2000', 'page' => $page, 'sort' => $sort, 'way' => $way]);
