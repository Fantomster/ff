                                    ...
                                    'buttons'        => [
                                        'clear' => function ($url, $model) {
                                            ...
                                            if ($model->id == 7) {
                                                ...
                                                $customurl = Yii::$app->getUrlManager()->createUrl(['clientintegr/tillypad/settings/change-const', 'id' => $model->id, 'page' => $page, 'sort' => $sort]);
                                            } else {
                                                $customurl = Yii::$app->getUrlManager()->createUrl(['clientintegr/tillypad/settings/change-const', 'id' => $model->id]);
                                            }
