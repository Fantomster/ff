...
//                        ['label' => 'Сообщения' . Html::tag('span', 4, ['class' => 'label label-danger pull-right']), 'icon' => 'envelope', 'url' => ['vendor/messages']],
    ['label' => 'F-MARKET<sub class="sub-new">NEW</sub>', 'icon' => 'shopping-cart', 'url' => 'http://market.f-keeper.ru', 'options' => ['class' => 'l-fmarket']],
    [
        'label' => 'Мои клиенты',
        'icon' => 'users',
        'url' => ['vendor/clients'],
