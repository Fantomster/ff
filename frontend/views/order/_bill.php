    ...
    <div class="block__wrapp" style="width: 100%;	height: 100%; padding: 20px;">
        ...
        <div style="width: 100%; height: 170px;">
            <div class = "sp_cen" style="width: 300px;float: right;">
                ...
                <?php } ?>
                <p  style="text-align: right;color: #82C073;font-size: 16px;border-bottom: 1px solid #DDDDDD; padding: 7px 0;padding-top: 2px; font-family: Circe_Bold"><?= Yii::t('message', 'frontend.views.order.delivery_price_four', ['ru'=>'Стоимость доставки:']) ?> <?= $order->calculateDelivery() ?> <?= Yii::t('message', 'frontend.views.order.rouble_nine', ['ru'=>'руб.']) ?></p>
                <p  style="text-align: right;color: #82C073;font-size: 16px;border-bottom: 1px solid #DDDDDD;  padding: 7px 0;padding-top: 2px; font-family: Circe_Bold"><?= Yii::t('message', 'frontend.views.order.total_price', ['ru'=>'Итого:']) ?> <?= $order->total_price ?><?= Yii::t('message', 'frontend.views.order.rouble_ten', ['ru'=>' руб.']) ?></p>
            </div>
        </div>
