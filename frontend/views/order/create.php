        ...
        <ul class="nav nav-tabs">
            ...
            <li>
                <a href="<?= Url::to(['order/guides']) ?>">
                    <?= Yii::t('message', 'frontend.views.order.orders_guides_two', ['ru'=>'Шаблоны заказов']) ?> <small class="label bg-yellow">new</small>
                </a>
            </li>
            <li>
                <a href="<?= Url::to(['order/favorites']) ?>">
                    <?= Yii::t('message', 'frontend.views.order.freq_goods_two', ['ru'=>'Часто заказываемые товары']) ?> <small class="label bg-yellow">new</small>
                </a>
            </li>
        </ul>
