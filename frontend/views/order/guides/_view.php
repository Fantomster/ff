...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12">
            ...
            <?php ActiveForm::end(); ?>
            <?php Pjax::end(); ?>
            <button style="margin-top: 20px;margin-right: 7px;"
                    class="btn btn-md btn-success pull-right add-guide-to-cart"
                    data-url="<?= Url::to(['order/ajax-add-guide-to-cart', 'id' => $guide->id]) ?>"><i
                        class="fa fa-paper-plane-o"></i> <?= Yii::t('message', 'frontend.views.order.guides.add_all', ['ru' => 'Добавить все']) ?>
            </button>
        </div>
    </div>
</div>
