...
swal({
  ...
  preConfirm: function () {
    ...
    if (result.dismiss === "cancel") {
        ...
        swal("' . Yii::t('message', 'frontend.views.request.ready', ['ru'=>'Готово!']) . ' ","' . Yii::t('message', 'frontend.views.request.closed', ['ru'=>'Заявка закрыта']) . ' ","success")
    }
})
});
...
swal({
  ...
  preConfirm: function () {
    ...
    if (result.dismiss === "cancel") {
        ...
        swal("' . Yii::t('message', 'frontend.views.request.ready_two', ['ru'=>'Готово!']) . ' ","' . Yii::t('message', 'frontend.views.request.inv_sent', ['ru'=>'Приглашение отправлено!']) . ' ","success")
    }
})
});
');?>