                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <h3 class="text-success">№<?= $request->id ?> <?= $request->product ?>
                                        <?php if ($request->rush_order) { ?>
                                            <span style="color:#d9534f"><i class="fa fa-fire"
                                                                           aria-hidden="true"></i> <?= Yii::t('message', 'frontend.views.request.common', ['ru' => 'СРОЧНО']) ?></span>
                                        <?php } ?>
                                    </h3>
                            ...
                            <h6>
                                <b><?= Yii::t('message', 'frontend.views.request.buying_value', ['ru' => 'Объем закупки:']) ?></b> <?= $request->amount ?>
                            </h6>
                            <h6>
                                <b><?= Yii::t('message', 'frontend.views.request.frequency', ['ru' => 'Периодичность заказа:']) ?></b> <?= $request->regularName ?>
                            </h6>
                            <h6>
                                <b><?= Yii::t('message', 'frontend.views.request.payment_variant', ['ru' => 'Способ оплаты:']) ?></b> <?= $request->paymentMethodName ?>
                            </h6>
                            ...
                            <p style="margin:0;margin-top:15px">
                                <b><?= Yii::t('message', 'frontend.views.request.created', ['ru' => 'Создана']) ?></b> <?= Yii::$app->formatter->format($request->created_at, 'datetime') ?>
                            </p>
                            <p style="margin:0;margin-bottom:15px">
                                <b><?= Yii::t('message', 'frontend.views.request.will_delete', ['ru' => 'Будет снята']) ?></b> <?= Yii::$app->formatter->format($request->end, 'datetime') ?>
                            </p>
                            ...
                            <div class="pull-right" style="margin-top: 9px">
                                <span data-toggle="tooltip" data-placement="bottom"
                                      data-original-title="<?= Yii::t('message', 'frontend.views.request.amount', ['ru' => 'Кол-во уникальных просмотров поставщиков']) ?>"><i
                                            class="fa fa-eye" style="font-size:19px !important"
                                            aria-hidden="true"></i> <?= $request->counter ?></span>
                                <span data-toggle="tooltip" data-placement="bottom"
                                      data-original-title="<?= Yii::t('message', 'frontend.views.request.vendors_offers', ['ru' => 'Предложений от поставщиков']) ?>"><i
                                            class="fa fa-handshake-o" style="font-size:19px !important"
                                            aria-hidden="true"></i> <?= $request->countCallback ?></span>
                            </div>
                        </div>
                        <div class="col-md-6">
