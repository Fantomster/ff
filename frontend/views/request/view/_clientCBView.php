...
<div class="row" style="padding:5px;border-radius:3px;background:#f7f7f7;margin-bottom:15px;">
    <div class="media">
        ...
        <div class="media-body">
            ...
            <p><?= Yii::t('message', 'frontend.views.request.service_price', ['ru' => 'Стоимость услуги:']) ?> <span
                        class="text-bold"><?= $model->price ?> </span></p>
            <p>
                <b><?= Yii::t('message', 'frontend.views.request.vendors_comment', ['ru' => 'Комментарий поставщика:']) ?></b> <?= $model->comment ?>
            </p>
        </div>
