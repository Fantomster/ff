                ...
                <div class="media-body" style="line-height: 1.6;">
                    <div class="row">
                        <div class="col-md-12" style="padding-right: 5px;">
                            ...
                            <h5><?= Yii::t('message', 'frontend.views.request.service_price_nine', ['ru' => 'Стоимость услуги:']) ?>
                                <span class="text-bold"><?= $model->price ?> </span></h5>
                            <p>
                                <b><?= Yii::t('message', 'frontend.views.request.vendors_comment_two', ['ru' => 'Комментарий поставщика:']) ?></b> <?= $model->comment ?>
                            </p>
                        </div>
                    </div>
                </div>
