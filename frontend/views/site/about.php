...
<main class="content content-inner ">
				...
				<div class="container-fluid">
					...
					<!--	<p><b>Здравствуйте, наша компания работает на рынке информационных технологий около 10 лет. </b></p> -->
						<p>Пришло время, когда работать без современной IT инфраструктуры просто невозможно. Мир изменился, и это стало неотъемлемой частью бизнеса.<br/>
						 ...
						 <br/>
						 В основу площадки MixCart был вложен наш 10 летний опыт работы по автоматизации бизнеса, продажам и решению сложных бизнес задач.
						 <br/>
						 <br/>Цель, которую мы ставим перед собой, автоматизировать закупки во всех ресторанах, кафе, барах России и СНГ.<br/>
			...
			<div class="error__block">
				<p>Хотите работать у нас? <a href="mailto:hr@mixcart.ru">hr@mixcart.ru</a></p>
			</div>
		</main><!-- .content -->