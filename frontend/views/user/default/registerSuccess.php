...
<div class="main-page-wrapper success">
    ...
    <div class="success-message"><a href="<?= Yii::$app->params['staticUrl']['home'] ?>" class="success-message__ico"></a>
        <div class="success-message__text"><?= Yii::t('message', 'frontend.views.user.default.success', ['ru'=>'Вы успешно зарегистрировались в системе']) ?> <a href="<?= Yii::$app->homeUrl; ?>">MixCart</a><br><?= Yii::t('message', 'frontend.views.user.default.email', ['ru'=>'На указанную Вами почту']) ?> <b><?= $user->email ?></b> <?= Yii::t('message', 'frontend.views.user.default.sent', ['ru'=>'было выслано письмо с подтверждением.<br>Для продолжения работы в системе пройдите по ссылке в письме.']) ?></div>
    </div>
