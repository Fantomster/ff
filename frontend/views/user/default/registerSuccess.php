...
<div class="main-page-wrapper success">
    ...
    <div class="success-message"><a href="<?= Yii::$app->homeUrl; ?>" class="success-message__ico"></a>
        <div class="success-message__text">Вы успешно зарегистрировались в системе <a href="<?= Yii::$app->homeUrl; ?>">f-keeper</a><br>на указанную Вами почту <a href="#"><?= $user->email ?></a>, было выслано письмо с подтверждением.<br>Для продолжения работы в системе, пройдите по ссылке в письме.</div>
    </div>
