                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <div class="col-md-6 text-left">
                            ...
                            <p class="small"><?= Yii::t('message', 'frontend.views.vendor.this_cat', ['ru'=>'Этот каталог содержит все ваши продукты доступные на MixCart']) ?></p>
                        </div>
                        ...
                        ?>
                                <div class="hpanel" style="margin-bottom:15px;">
                                    <div class="panel-body">
                                        ...
                                        <p class="small m-b-none"><?= Yii::t('message', 'frontend.views.vendor.created_at', ['ru'=>'Создан:']) ?> <?=Yii::$app->formatter->asDatetime($arrCatalogs->created_at, "php:j M Y"); ?></p>
                                        </div>
