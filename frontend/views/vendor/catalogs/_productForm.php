...
<div class="modal-header">
    ...
    <h4 class="modal-title"><?= Yii::t('message', 'frontend.views.vendor.edit_good_two', ['ru'=>'Редактировать продукт']) ?></h4>
</div>
...
<div class="modal-footer">
    <?= Html::button('<i class="icon fa fa-save"></i> ' . Yii::t('message', 'frontend.views.vendor.save_four', ['ru'=>'Сохранить']) . ' ', ['class' => 'btn btn-success edit']) ?>
    <a href="#" class="btn btn-gray" data-dismiss="modal"><i class="icon fa fa-ban"></i> <?= Yii::t('message', 'frontend.views.vendor.cancel_nine', ['ru'=>'Отмена']) ?></a>
</div>
<?php ActiveForm::end(); ?>
<?php
$this->registerJs('
