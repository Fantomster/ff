    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="panel-body">
                <?=
                Html::a(
                        '<i class="icon fa fa-save"></i> ' . Yii::t('message', 'frontend.views.vendor.save_six', ['ru' => 'Сохранить']) . ' ', ['#'], ['class' => 'btn btn-success pull-right', 'style' => ['margin-left' => '5px'], 'id' => 'save', 'name' => 'save']
                )
                ?>
                <?=
                Html::a('<i class="glyphicon glyphicon-import"></i> <span class="text-label">' . Yii::t('message', 'frontend.views.vendor.downl_cat_two', ['ru' => 'Загрузить каталог (XLS)']) . ' </span>', ['/vendor/import-base-catalog-from-xls'], [
                    'data' => [
                ...
                <?=
                Html::a(
                        '<i class="fa fa-list-alt"></i> ' . Yii::t('message', 'frontend.views.vendor.downl_templ_two', ['ru' => 'Скачать шаблон']) . ' ', Url::to('@web/upload/template.xlsx'), ['class' => 'btn btn-default pull-right', 'style' => ['margin' => '0 5px;']]
                )
                ?>
                <?=
