      ...
      <div class="row">
        <div class="col-md-8 col-lg-8">
            <div class="row">
              ...
              <?php } else {?>
              <h2 style="padding-bottom:15px"><?=floatval($product->price); ?> <small><?= Yii::t('message', 'market.views.site.product.rouble', ['ru'=>'руб.']) ?></small></h2>
              <?php } ?>
                </div>
...
$this->registerJs($js2, \yii\web\View::POS_READY);
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6"> 
                    <h5><span class="title-param"><?= Yii::t('message', 'market.views.site.product.country', ['ru'=>'Страна:']) ?></span> <?= empty($product->region) ? '<span class="noinfo">' . Yii::t('message', 'market.views.site.product.no_info', ['ru'=>'нет информации']) . ' </span>':$product->mpRegion->name ?></h5>
                    <h5><span class="title-param"><?= Yii::t('message', 'market.views.site.product.measure', ['ru'=>'Ед. измерения:']) ?></span> <?= empty($product->ed) ? '<span class="noinfo">' . Yii::t('message', 'market.views.site.product.no_info_two', ['ru'=>'нет информации']) . '</span>':$product->ed ?></h5>
                ...
                <div class="col-md-6">
                    <h5><span class="title-param"><?= Yii::t('message', 'market.views.site.product.price_two', ['ru'=>'Стоимость доставки:']) ?></span> <?= $delivery->delivery_charge ?> <?= Yii::t('message', 'market.views.site.product.rouble_two', ['ru'=>'руб.']) ?></h5>
                    <h5><span class="title-param"><?= Yii::t('message', 'market.views.site.product.free_delivery', ['ru'=>'Бесплатная доставка от:']) ?></span> <?= $delivery->min_free_delivery_charge ?> <?= Yii::t('message', 'market.views.site.product.rouble_three', ['ru'=>'руб.']) ?></h5>
                    <h5><span class="title-param"><?= Yii::t('message', 'market.views.site.product.min', ['ru'=>'Минимальный заказ:']) ?></span> <?= $delivery->min_order_price ?> <?= Yii::t('message', 'market.views.site.product.rouble_four', ['ru'=>'руб.']) ?></h5>
