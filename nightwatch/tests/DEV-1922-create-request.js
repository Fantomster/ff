...
module.exports = {
	before: function (browser) {
		console.log('Begining test DEV-1922 creating request...');
	},

	after: function (browser) {
		console.log('Finishing test DEV-1921 creating request...');
		browser.end();
	},

	'Test DEV-1922 creating request': function (browser) {
